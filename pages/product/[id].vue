<template>
    <div v-for="image in additionalData" class="max-w-7xl mx-auto">
        ...
        <div class="flex mt-4 md:mt-6">
                    <a v-if="cartStore.compare[product.id] === -1" @click="addToCart(product), syncCompare(), cartStore.cart[cartStore.compare[product.id]].amount = 0, cartStore.cart[cartStore.compare[product.id]].amountSumm = product.price, cartStore.cart[cartStore.compare[product.id]].amount++"
                        href="#"
